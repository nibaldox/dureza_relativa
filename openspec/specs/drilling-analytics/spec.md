...
#### S-4. Slider re-classifies under 1 s
...
#### S-5. Defaults reproduce current behavior
...
#### S-10. Export reflects active filters
...
#### S-12. Pure module has zero side-effecting imports
...
#### S-13. Golden JSON fixture covers every pure function
...
#### S-14. Parity debt markers on Python-only adapters
